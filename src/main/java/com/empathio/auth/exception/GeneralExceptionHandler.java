...
import com.empathio.auth.exception.attributes.ApiResponse;
import com.empathio.auth.exception.attributes.SeverityLevel;
import com.empathio.auth.jwt.AuthUtils;
...
public class GeneralExceptionHandler {
    ...
    public ResponseEntity<ApiResponse> handleConflictExceptions(Exception exception) {
